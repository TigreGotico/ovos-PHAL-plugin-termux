...
def get_version():
    ...
    version_file = os.path.join(BASEDIR, 'ovos_PHAL_plugin_termux', 'version.py')
...
setup(
    ...
    license='Apache-2.0',
    packages=['ovos_PHAL_plugin_termux'],
    package_data={'': package_files('ovos_PHAL_plugin_termux')},
